      ...
      <div className="bg-black bg-opacity-30 backdrop-blur-md p-4 sm:p-6 md:p-8 lg:p-12 rounded-3xl shadow-2xl w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-3xl text-center">
        ...
        <h1
          className="
            ...
            font-extrabold text-white mb-4 sm:mb-6 
        ...
        {/* 설명 */}
        <div className="text-sm sm:text-base lg:text-lg xl:text-xl text-gray-200 leading-relaxed mb-4 sm:mb-6">
          ...
          <p className="mt-2 sm:mt-4">
            ...
            <a
              ...
              className="
                ...
                bg-blue-500 px-2 sm:px-3 py-1 rounded-lg 
